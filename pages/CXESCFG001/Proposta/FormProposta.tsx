...
const FormProposta = ({
  ...
  const [selectedTemplate, setSelectedTemplate] = useState(
    defaultValues?.template_proposta ? defaultValues["template_proposta"] : "1"
  );
  ...
  const { ...formTemplate } = GetForm(yupTemplateSchema, setYupTemplateSchema);
          ...
          >
            ...
            >
              <InputSelectComponent
                ...
                onChange={(e: any) => setSelectedTemplate(e.value)}
              ...
              <Input
                ...
                formulario={formTemplate}
                type="textarea"
                defaultValue={defaultValues && defaultValues["quem_somos"]}
              />
              <div className="w-full">
                ...
                <InputGroup>
                  <Input
                    ...
                    formulario={formTemplate}
                    defaultValue={
                      defaultValues && defaultValues["motivo_escolha1"]
                    }
                  />
                  <Input
                    ...
                    formulario={formTemplate}
                    defaultValue={
                      defaultValues && defaultValues["motivo_escolha3"]
                    }
                  />
                </InputGroup>
                <InputGroup>
                  <Input
                    ...
                    formulario={formTemplate}
                    defaultValue={
                      defaultValues && defaultValues["motivo_escolha2"]
                    }
                  />
                  <Input
                    ...
                    formulario={formTemplate}
                    defaultValue={
                      defaultValues && defaultValues["motivo_escolha4"]
                    }
                  />
                </InputGroup>
              </div>
              <div className="w-full">
                ...
                <div className="w-full flex flex-row justify-center">
                  <Button
                    ...
                    type="button"
                    onClick={() =>
                      setTermos([...termos, { item: "", descricao: "" }])
                    }
                  >
                    +
                  </Button>
            ...
            <div className="flex flex-row-reverse py-3 w-full bg-bodydark dark:bg-black text-white">
              <div className="flex flex-row gap-2">
                <Button
                  type="button"
                  onClick={() => setIsTemplateConfigOpen(false)}
                  className="bg-body"
                >
                  Cancelar
                </Button>
      ...
      <form onSubmit={handleSubmit(onSubmitFunction)} {...rest}>
        ...
        <InputGroup align="center">
          ...
          <Input
            ...
            required
            defaultValue={
              defaultValues && defaultValues["adicional_maximo_parametro"]
            }
            maxLength={6}
          />
          <Input
            ...
            required
            defaultValue={
              defaultValues && defaultValues["desconto_maximo_parametro"]
            }
            maxLength={5}
          />
        </InputGroup>
        <InputGroup align="center">
          <Input
            ...
            required
            defaultValue={
              defaultValues && defaultValues["reajuste_rsi_parametro"]
            }
            maxLength={5}
          />
          <Input
            ...
            required
            defaultValue={
              defaultValues && defaultValues["margem_depreciacao_parametro"]
            }
          />
          <Input
