...
function DesignerContrato() {
          ...
          repetidos.map((repetido) => {
            ...
            toast.error(
              `Não é possível salvar pois "${repetido}" se repete ${
                paginaRepetidos.length > 1 ? "nas páginas" : "na página"
  ...
  return (
    <div className="relative flex flex-col gap-2">
        ...
        <Menubar>
          <MenubarMenu>
            ...
            <MenubarContent>
              ...
              <MenubarItem>
                <form
                  onSubmit={formDeleteValue.handleSubmit(submitDeleteValue)}
          ...
          <MenubarMenu>
            ...
            <MenubarContent>
              <MenubarItem onClick={() => generatePDF(designer.current)}>
                <div className="pr-2">
                  <GrDocumentPdf />
                </div>
                Gerar PDF
          ...
          <button
            onClick={() => setShowRelationsAccordion(!showRelationsAccordion)}
      ...
      />
      <div
        className={`bg-black-2 fixed top-[15%] right-3 w-[30px] h-[40px] z-0 ${
      ...
      >
        <div
          ...
          } duration-300 w-[30px] h-[40px] flex flex-col items-center justify-center text-white`}
        >
          <GrNext />
        </div>
      </div>
